...
3. Predict stated cause of fire using one versus the rest classification method
...
The dataset for analysis of wildfire in California initially contained thirteen features. The features 'COUNTY', and 'FIPS_NAME' had about 70% of values missing, and were therefore dropped. Categorical variables such as 'FIRE_SIZE_CLASS' and 'STAT_CAUSE_DESCR' are converted into dummy variables. 
