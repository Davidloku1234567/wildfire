...
The dataset for wildfire in California initially contained thirteen features. The features 'COUNTY', and 'FIPS_NAME' had about 70% of values missing, and were therefore dropped. Categorical variables such as 'FIRE_SIZE_CLASS' and 'STAT_CAUSE_DESCR' are converted into dummy variables. 
